...
DECLARE
  ...
  v_admin uuid := 'a0000000-0000-0000-0000-000000000001'::uuid;
  v_ff1   uuid := 'ff100000-0000-0000-0000-000000000001'::uuid;
  v_ff2   uuid := 'ff200000-0000-0000-0000-000000000002'::uuid;
  v_c1    uuid := 'c1000000-0000-0000-0000-000000000001'::uuid;
  v_c2    uuid := 'c2000000-0000-0000-0000-000000000002'::uuid;
  v_c3    uuid := 'c3000000-0000-0000-0000-000000000003'::uuid;
  v_c4    uuid := 'c4000000-0000-0000-0000-000000000004'::uuid;
  v_c5    uuid := 'c5000000-0000-0000-0000-000000000005'::uuid;
  v_c6    uuid := 'c6000000-0000-0000-0000-000000000006'::uuid;
